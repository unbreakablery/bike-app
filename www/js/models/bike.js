...
var bikeModel = {
  ...
  charge: () => {
    ...
    bikeModel.bCEID = setInterval(function() {
      if (bikeModel.currentBike.battery <= 0 && bikeModel.switch == false) {
  ...
  velocityEmulate: () => {
    bikeModel.vEID = setInterval(function() {
      ...
      } else if (bikeModel.currentBike.battery <= 0 && bikeModel.currentBike.velocity >= 20) {
        bikeModel.currentBike.velocity -= 20;
      } else if (bikeModel.currentBike.battery <= 0 && bikeModel.currentBike.velocity < 20) {
      ...
      if (!bikeModel.switch && bikeModel.currentBike.velocity > 0) {
        if (bikeModel.currentBike.velocity >= 20) {
          bikeModel.currentBike.velocity -= 20;
        } else {
          bikeModel.currentBike.velocity = 0;
